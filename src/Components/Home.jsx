    ...
    <Row>
      ...
      <Col sm={9} className='body'>
            ...
            <div className='dash-textimonials'>
              <Card style={{width:'30%', boxShadow:'rgba(0, 0, 0, 0.24) 0px 3px 8px', padding:'0%' }}>
                <Card.Body>
                  <b>Sales</b>
                  <h5>$230,430</h5>
            ...
            <div className='pie-line'>
              <Card style={{width:'32%', boxShadow:'rgba(0, 0, 0, 0.24) 0px 3px 8px', margin:'5px, 5px, 5px, 5px', padding:'0%' }}>
              ...
              <Card style={{width:'70%', boxShadow:'rgba(0, 0, 0, 0.24) 0px 3px 8px',marginLeft:'2%', padding:'0%' }}>
              <Card.Body>
                <b>Revenue</b>
                <ErrorOutlineIcon className='icon'/>
                <BiaxialLineChart/>
              ...
              <Card style={{width:'100%', boxShadow:'rgba(0, 0, 0, 0.24) 0px 3px 8px',marginRight:'2%', padding:'0%' }}>
                <Card.Body>
                  ...
                  <table>
                    ...
                    <tr>
                      <td style={{display:'flex'}}>
                        <img src="https://images.unsplash.com/photo-1700864182167-a619bf74f46c?q=80&w=1636&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
                        <div>
