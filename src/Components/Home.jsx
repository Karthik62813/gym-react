    ...
    <Row className='home'>
      ...
      <Col sm={9} className='home-body'>
        <div className='dash-textimonials'>
          <Card className='home-card' style={{width:'30%', boxShadow:'rgba(0, 0, 0, 0.24) 0px 3px 8px', padding:'0%', backgroundColor: '#373A40' }}>
            <Card.Body>
              <b className='side-heads'>Sales</b>
              <h5>$230,430</h5>
              <p><b style={{color:'green'}}>+55%</b> since last month</p>
            </Card.Body>
          </Card>

          <Card style={{width:'30%', boxShadow:'rgba(0, 0, 0, 0.24) 0px 3px 8px', padding:'0%', backgroundColor: '#373A40' }}>
            <Card.Body>
              <b className='side-heads'>Customers</b>
              <h5>3.200</h5>
          ...
          <Card style={{width:'30%', boxShadow:'rgba(0, 0, 0, 0.24) 0px 3px 8px', padding:'0%', backgroundColor: '#373A40'}}>
            <Card.Body>
              <b className='side-heads'>Avg. revenue</b>
              <h5>$1.200</h5>
        ...
        <div className='pie-line'>
          <Card style={{width:'34%', boxShadow:'rgba(0, 0, 0, 0.24) 0px 3px 8px', margin:'5px, 5px, 5px, 5px', padding:'0%', backgroundColor: '#373A40'}}>
            <Card.Body className='pie-card'>
              <b className='side-heads'>Channels</b>
              <ErrorOutlineIcon className='icon'/>
              <PieChart
                series={[
                  {
                    data: [
                      { id: 0, value: 10, label: 'Gym' },
                      { id: 1, value: 15, label: 'Sleep' },
                      { id: 2, value: 20, label: 'Diet' },
                    ],
          ...
          <Card style={{width:'68%', boxShadow:'rgba(0, 0, 0, 0.24) 0px 3px 8px',marginLeft:'2%', padding:'0%' , backgroundColor: '#373A40'}}>
          <Card.Body>
            <b className='side-heads'>Revenue</b>
            <ErrorOutlineIcon className='icon'/>
            <BiaxialLineChart/>
          </Card.Body>
          </Card>
        ...
        <div className='bar-data'>
          <Card style={{width:'60%', boxShadow:'rgba(0, 0, 0, 0.24) 0px 3px 8px',marginRight:'2%', padding:'0%' , backgroundColor: '#373A40'}}>
          <Card.Body>
            <b className='side-heads'>Sales by age</b>
            <CustomLabels/>
          </Card.Body>
          </Card>

          <Card style={{width:'40%', boxShadow:'rgba(0, 0, 0, 0.24) 0px 3px 8px', margin:'5px, 5px, 5px, 5px', padding:'0%', backgroundColor: '#373A40' }}>
            <Card.Body >
              <b className='side-heads'>Sales By Country</b>
        ...
        <div className='top-sales'>
          <Card style={{width:'100%', boxShadow:'rgba(0, 0, 0, 0.24) 0px 3px 8px',marginRight:'2%', padding:'0%' , backgroundColor: '#373A40'}}>
            <Card.Body>
              <b className='side-heads'>Top Selling Products</b><br />
              <table>
